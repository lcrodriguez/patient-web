...
import FormDoctor from '../../pages/doctor/form/form';
import DoctorList from '../../pages/doctor';

import FormPatient from '../../pages/patient/form/form';
import PatientList from '../../pages/patient';

import FormClinic from '../../pages/clinic/form/form';
import ClinicList from '../../pages/clinic';

import FormMedicine from '../../pages/medicine/form/form';
import MedicineList from '../../pages/medicine';

import FormTake from '../../pages/take/form/form';
import TakeList from '../../pages/take';

import FormBucket from '../../pages/bucket/form/form';
import BucketList from '../../pages/bucket';

import ProtocolList from '../../pages/protocol';
import FormProtocol from '../../pages/protocol/form/form';
          ...
          <Hammer onSwipe={this.handleSwipe}>
            <main className={s.content}>
              <Switch>
                ...
                <Route path="/app/doctor/list" exact component={DoctorList} />
                <Route path="/app/doctor/create" exact component={FormDoctor} />
                <Route path="/app/doctor/update" exact component={FormDoctor} />
                <Route path="/app/patient/list" exact component={PatientList} />
                <Route path="/app/patient/create" exact component={FormPatient} />
                <Route path="/app/patient/update" exact component={FormPatient} />
                <Route path="/app/clinic/list" exact component={ClinicList} />
                <Route path="/app/clinic/create" exact component={FormClinic} />
                <Route path="/app/clinic/update" exact component={FormClinic} />
                <Route path="/app/medicine/list" exact component={MedicineList} />
                <Route path="/app/medicine/create" exact component={FormMedicine} />
                <Route path="/app/medicine/update" exact component={FormMedicine} />
                <Route path="/app/take/list" exact component={TakeList} />
                <Route path="/app/take/create" exact component={FormTake} />
                <Route path="/app/take/update" exact component={FormTake} />
                <Route path="/app/bucket/list" exact component={BucketList} />
                <Route path="/app/bucket/create" exact component={FormBucket} />
                <Route path="/app/bucket/update" exact component={FormBucket} />
                <Route path="/app/protocol/list" exact component={ProtocolList} />
                <Route path="/app/protocol/create" exact component={FormProtocol} />
                <Route path="/app/protocol/update" exact component={FormProtocol} />
